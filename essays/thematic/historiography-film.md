...
{% include figure.html
  class="right"
  width="35%"
  caption="Actors Christoph Waltz (left) and Jamie Foxx (right) in Quentin Tarantino’s *Django Unchained*. Waltz portrayed fictional German bounty hunter Dr. King Schultz who assists Foxx's Django in an action western film. Photo credit Il Fatto Quotidiano."
...
Historical movies tend to “focus on the portrayal of real events and people,” but historical *fiction* movies (like *Marie Antoinette, Titanic,* and *Pearl Harbor*) “are artistic and creative interpretations of real events [that] struggle with ‘the problem of truth’ because ‘meaning lies not in a chain of events themselves but in the writer’s interpretation of what occurred.’” (Cui et al, 2743) Without inherently wishing to do so, filmmakers who create historical *fiction* narratives are *persuading* an audience to believe something happened that, although based on some fact, did not entirely happen. Marie Antoinette was more complex of a human being than Sophia Coppola’s film led audiences to believe; but the movie is still nice to watch.

### Conclusion ###
As a medium, film is one of the best ways for history to be accessible to the general public. When it comes to accuracy and transparency, it is the responsibility of the filmmaker, whether that be the screenwriter, director, or producer to do the work; become the occasional historian so that the final product being presented for (mass) consumption by large audiences in a way that is beneficial for their learning and entertainment.
