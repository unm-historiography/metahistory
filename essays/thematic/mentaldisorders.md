...
Research has shown through the 22 point scale of Robert Hare, that significant leaders in global society portray traits of *psychopathy*. The highest, and worst score is equated 40, whilst the minimum requirement for an individual is a score of 26 to be diagnosed as a *psychopath*. Unsurprisingly, "Donald Trump scored equivalently with Adolf Hitler on this scale, and, Hillary Clinton scored closely with Napoleon Bonaparte" (6). These **mental disorders** are apparently, not always equivalent to a negative prerogative depending on political and societal structures.   
